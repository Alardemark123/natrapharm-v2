      ...
      <div className="p-6">
        <div className="flex items-start gap-3 mb-3">
          <div className="w-10 h-10 bg-[#e12328] rounded-lg flex items-center justify-center flex-shrink-0">
            <Package className="w-5 h-5 text-[#e12328]" />
          </div>
          <div className="flex-1">
            <h3 className="font-display text-xl font-semibold text-black mb-2 group-hover:text-[#e12328] transition-colors duration-300">
              {product.name}
            </h3>
          </div>
        </div>
